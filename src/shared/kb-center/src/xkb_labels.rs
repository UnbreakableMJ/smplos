...
fn physical_layout() -> [Vec<PhysicalKey>; 5] {
    [
        ...
        vec![
            PhysicalKey::key(49),                       // ` ~
            PhysicalKey::key(10), PhysicalKey::key(11), // 1 2
            PhysicalKey::key(12), PhysicalKey::key(13), // 3 4
            PhysicalKey::key(14), PhysicalKey::key(15), // 5 6
            PhysicalKey::key(16), PhysicalKey::key(17), // 7 8
            PhysicalKey::key(18), PhysicalKey::key(19), // 9 0
        ...
        vec![
            ...
            PhysicalKey::key(24), PhysicalKey::key(25), // Q W
            PhysicalKey::key(26), PhysicalKey::key(27), // E R
            PhysicalKey::key(28), PhysicalKey::key(29), // T Y
            PhysicalKey::key(30), PhysicalKey::key(31), // U I
            PhysicalKey::key(32), PhysicalKey::key(33), // O P
        ...
        vec![
            ...
            PhysicalKey::key(38), PhysicalKey::key(39), // A S
            PhysicalKey::key(40), PhysicalKey::key(41), // D F
            PhysicalKey::key(42), PhysicalKey::key(43), // G H
            PhysicalKey::key(44), PhysicalKey::key(45), // J K
            PhysicalKey::key(46),                       // L
        ...
        vec![
            ...
            PhysicalKey::key(52), PhysicalKey::key(53), // Z X
            PhysicalKey::key(54), PhysicalKey::key(55), // C V
            PhysicalKey::key(56), PhysicalKey::key(57), // B N
            PhysicalKey::key(58),                       // M
        ...
        vec![
            ...
            PhysicalKey::modifier(65, 6.25, ""),        // spacebar
...
fn resolve_row(
    ...
    row.into_iter()
        .map(|pk| {
            ...
            // Get corresponding US key label for mapping reference
            let eng = us_state
                .map(|s| {
            ...
            // Only show english label when it differs from local
...
pub fn resolve(layout: &str, variant: &str) -> (String, Vec<KeyInfo>, Vec<KeyInfo>, Vec<KeyInfo>, Vec<KeyInfo>, Vec<KeyInfo>) {
    ...
    // Also resolve US layout for english reference labels
    ...
    match keymap {
        Some(km) => {
            // Get human-readable layout name (e.g. "Russian (phonetic)")
            let name = {
